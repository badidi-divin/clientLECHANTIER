    ...
    <div class="container col-12" >
        <a href="client.php">Retour>>>></a>
                <div class="row mb-4" align="left">
                    ...
                    <h3 class="text-dark mb-1">LE CHANTIER</h3>
                    <div>Email:lechantierjohn@yahoo.fr</div>
                    <div>Phone: +243 9 98 111 838</div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        LISTE DES CLIENTS - <?= $dates;  ?> - <?= $extension;  ?> <a onclick="window.print();">ici</a>
                    </div>
